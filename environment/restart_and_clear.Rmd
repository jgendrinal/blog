...
Restarting deletes all the objects you have in your workspace. Basically, you start your R session as if nothing had happened in the past.  

If you're on rstudio you can use the `.rs.restartR()` command in the console or use the following shortcuts:  
