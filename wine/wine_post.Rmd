...
We will use the nnet package for our multinomial logistic regression. We will structure it so that the output of this function is a model.  
```{r}
mnom <- function(df){
  multinom(class ~ 
             dil + 
...
The distribution is not gaussian, but more scores ten toward a 95% accuracy on the part of this model.  
