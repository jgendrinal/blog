...
This blog post cannot promise a thorough analysis, but hopefully this would be a good starting point for someone to better understand how many factors can affect prices.  
...
# Ask for weights for goods in CPI
```
